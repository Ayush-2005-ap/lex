...
import { ChevronRight, ArrowLeft, FileText, Calendar, Book, Scale, BookOpen } from 'lucide-react';
      ...
      issues: [
        {
          ...
          papers: [
            { id: 466, title: "HARMONIZING TRADE, ENVIRONMENTAL GOALS, AND CARBON TAXATION: A PERSPECTIVE ON THE EU’S CBAM POLICY", author: "Dr. Ankit Awasthi & Ms. Sriradha Rai Choudhuri", pages: "1-25", pdf: "/Pdfs/Papers34/1.pdf" },
            { id: 467, title: "LEGAL REGIME ON MOB LYNCHING: A COMPARATIVE ANALYSIS OF INDIAN AND AMERICAN SCENARIO", author: "Anoop Kumar & Harinath Prasad", pages: "26-36", pdf: "/Pdfs/Papers34/2.pdf" },
            { id: 468, title: "PUBLIC POLICY EXCEPTIONS IN JUDICIAL REVIEW OF INTERSTATE ARBITRATION AWARDS: “THEIR ROLE AND IMPACT", author: "Kumari Neha & Dr. Suneel Kumar", pages: "37-55", pdf: "/Pdfs/Papers34/3.pdf" },
            { id: 469, title: "REVEALING WOMEN’S MARGINALISATION IN THE INDIAN JUDICIARY: OBSTACLES AND POSSIBILITIES FOR PARITY", author: "Rimjhim Rana Singh & Dr. Sanya Yadav", pages: "56-67", pdf: "/Pdfs/Papers34/4.pdf" },
            { id: 470, title: "CORPORATE LIABILITY FOR DATA BREACHES IN INDIA: LEGAL FRAMEWORK, CHALLENGES AND IMPLICATIONS", author: "Manisha Debnath", pages: "68-76", pdf: "/Pdfs/Papers34/5.pdf" },
            { id: 471, title: "HUMAN RIGHTS IN INDIA: CONTEMPORARY CHALLENGES AND SOLUTIONS", author: "Vanshika Dhiman", pages: "77-90", pdf: "/Pdfs/Papers34/6.pdf" },
            { id: 472, title: "A COMPARATIVE LEGAL ANALYSIS OF LIABILITY AND INSURANCE REGIMES IN SPACE TOURISM: EVOLVING DOCTRINES AND REGULATORY CHALLENGES IN INDIAN NATIONAL LEGISLATION AND U.S. FEDERAL LEGISLATION", author: "Dr. Nitin Ramling Kumbhar ", pages: "91-101", pdf: "/Pdfs/Papers34/7.pdf" },
            { id: 473, title: "TRANSGENDER INCLUSION IN INDIA: CHALLENGES IN EMPLOYMENT, EDUCATION, AND HEALTHCARE", author: "Urvashi Pacherya & Dr. D. P. Gupta ", pages: "102-113", pdf: "/Pdfs/Papers34/8.pdf" },
          ]
        },
        {
          id: 42,
          ...
          papers: [
            { id: 474, title: "BALANCING FREEDOM OF RELIGION AND FREEDOM OF EXPRESSION: REVIEW OF THE BLASPHEMY LAWS IN NIGERIA", author: "Sophia Chima", pages: "1-18", pdf: "/Pdfs/Papers35/1.pdf" },
            { id: 475, title: "ALGORITHMIC ACCOUNTABILITY IN CORPORATE DECISION-MAKING: RECONSTRUCTING LIABILITY FRAMEWORKS FOR AI-DRIVEN GOVERNANCE", author: "Lakshya Kaushish & Deepanshi Tiwari", pages: "19-41", pdf: "/Pdfs/Papers35/2.pdf" },
            { id: 476, title: "THE GREEN PARADOX: THE ENVIRONMENTAL IMPLICATIONS OF FDI IN A GLOBALISING WORLD", author: "Dhairya Jain & Dr Ankit Awasthi ", pages: "42-61", pdf: "/Pdfs/Papers35/3.pdf" },
            { id: 477, title: "KAMAKHYA: THE CRADLE OF TANTRA IN NORTHEAST INDIA", author: "Dr Keshav Jha", pages: "62-64", pdf: "/Pdfs/Papers35/4.pdf" },
            { id: 478, title: "AVATARS IN THE EYES OF THE LAW RE-IMAGINING INTELLECTUAL PROPERTY FOR FICTIONAL CHARACTERS IN INDIA’S DIGITAL AGE", author: "Pankaj Kaushish & Alayna Amin", pages: "65-79", pdf: "/Pdfs/Papers35/5.pdf" },
            { id: 479, title: "LEGAL PROTECTION OF “KOKBOROK”: THE PRIDE OF NORTHEAST INDIA", author: "Dr Keshav Jha", pages: "80-84", pdf: "/Pdfs/Papers35/6.pdf" },
            { id: 480, title: "CONFLICT TO CONSENSUS: MEDIATION PRACTICES IN JHARKHAND’S FAMILY DISPUTES", author: "Bishnanand Dubey & Dr Laxmikanta Das", pages: "85-103", pdf: "/Pdfs/Papers35/7.pdf" },
            { id: 481, title: "GEOGRAPHICAL INDICATIONS AND TRADE LAW: LEGALGEOGRAPHICAL INDICATIONS AND TRADE LAW: LEGAL CHALLENGES IN PROMOTING UTTAR PRADESH’S GI-TAGGED HANDICRAFTS IN GLOBAL MARKETS", author: "Nikki Kumar & Dr Anis Ahmad", pages: "104-111", pdf: "/Pdfs/Papers35/8.pdf" },
            { id: 482, title: "NAVIGATING TRANSFER PRICING: ISSUES AND CHALLENGES IN THE ERA OF BEPS 2.0", author: "Ramya S. R. & Dr Sanjay Kumar", pages: "112-127", pdf: "/Pdfs/Papers35/9.pdf" },
            { id: 483, title: "NAVIGATING ETHICAL AI AND CORPORATE GOVERNANCE: DESIGNING INTERNAL COMPLIANCE FOR RESPONSIBLE AI USE", author: "Plabanee Patnaik & Sidhant Soin", pages: "128-144", pdf: "/Pdfs/Papers35/10.pdf" },
            { id: 484, title: "NORTHEAST INDIA’S TANTRIC TEXT AND ITS INTERPRETATION THROUGH MIMANSA", author: "Dr Keshav Jha", pages: "145-148", pdf: "/Pdfs/Papers35/11.pdf" },
            { id: 485, title: "UNFAIR PRACTICES IN THE GIG ECONOMY: WORKER RIGHTS AND CONSUMER IMPACT", author: "Pradeep Dixit ", pages: "149-165", pdf: "/Pdfs/Papers35/12.pdf" },
            { id: 486, title: "THE LEGAL FRAMEWORK OF EMPLOYMENT CONTRACTS: RIGHTS AND OBLIGATIONS", author: "P Gokulapriya ", pages: "166-177", pdf: "/Pdfs/Papers35/13.pdf" },
          ]
        },
        {
          id: 43,
          ...
          papers: [
            ...
            { id: 488, title: "PROPORTIONALITY IN NDPS SENTENCING: JUDICIAL APPROACHES", author: "Himanshu Priyadarshi", pages: "22-36", pdf: "/Pdfs/Papers36/2.pdf" },
            { id: 489, title: "WOMEN, TRADE AND LAW: LEGAL PERSPECTIVES ON WOMEN’S ECONOMIC EMPOWERMENT", author: "Hriti Parekh & Dr Ankit Awasthi", pages: "37-46", pdf: "/Pdfs/Papers36/3.pdf" },
            { id: 490, title: "WOMEN WORKERS IN TEA PLANTATION: A STUDY ON THE WORKING CONDITIONS AND LABOUR WELFARE IN BALIJAAN TEA ESTATE, DIBRUGARH DISTRICT, ASSAM", author: "Sangita Hazarika, Dr Baloy Bhattacharjee & Dr Sachchidanand S. Das", pages: "47-65", pdf: "/Pdfs/Papers36/4.pdf" },
            { id: 491, title: "CONSUMER DATA SHARING IN URBAN INDIA: THE ROLE OF PRIVACY AND DATA PROTECTION STANDARDS AMONG E-COMMERCE USERS", author: "Adarsh Philip Roy", pages: "66-96", pdf: "/Pdfs/Papers36/5.pdf" },
            { id: 492, title: "PREPARING FUTURE TEACHERS - FOCUS AND IMPETUS REQUIRED AT THE TRAINING LEVEL: A REVIEW OF TEACHING PRACTICE IN THE LIGHT OF INDIA’S NATIONAL EDUCATIONAL POLICY, 2020", author: "Priyanka", pages: "97-111", pdf: "/Pdfs/Papers36/6.pdf" },
            { id: 493, title: "CHILD CARE INSTITUTIONS IN INDIA", author: "Priya Tiwari", pages: "112-116", pdf: "/Pdfs/Papers36/7.pdf" },
            { id: 494, title: "VEDIC EGALITARIANISM, ĒKATMĀ MĀNAVAVĀD AND THEIR INFLUENCE ON GENDER-JUST LEGAL FRAMEWORKS IN NATIONAL SECURITY", author: "Dr Keshav Jha", pages: "117-121", pdf: "/Pdfs/Papers36/8.pdf" },
  ...
  const renderVolumes = () => (
    <div className="space-y-8">
      <div className={`text-center transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
        <h1 className="text-5xl sm:text-6xl font-bold bg-gradient-to-r from-amber-600 via-red-600 to-amber-600 bg-clip-text text-transparent mb-4">
          Journal Archives
        </h1>
        <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
          Explore our comprehensive collection of scholarly research spanning a decade of legal and social studies excellence.
        </p>
      </div>

      <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 transform transition-all duration-1000 delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
        {volumes.map((volume, index) => (
          <div
            key={volume.id}
            onClick={() => handleVolumeClick(volume)}
            className="group relative bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/20 transform transition-all duration-500 hover:scale-105 hover:shadow-2xl cursor-pointer"
            style={{ animationDelay: `${index * 50}ms` }}
          >
            <div className="absolute inset-0 bg-gradient-to-br from-amber-500/10 to-red-600/10 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>

            <div className="relative z-10">
              <div className="flex items-center justify-center w-20 h-20 bg-gradient-to-br from-slate-700 via-blue-700 to-indigo-700 text-white rounded-2xl mb-4 mx-auto group-hover:scale-110 transition-transform duration-300 shadow-lg">
                <span className="text-3xl font-bold">{volume.number}</span>
              </div>
              ...
              <div className="flex items-center justify-center gap-2 text-gray-600 mb-4">
                ...
                <span className="text-lg font-semibold">{volume.year}</span>
              </div>

              <div className="text-center">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-slate-50 to-blue-50 rounded-full">
                  <Book className="w-4 h-4 text-slate-600" />
                  <span className="text-sm font-medium text-gray-700">{volume.issues.length} Issues</span>
                </div>
              </div>

              <div className="flex items-center justify-center mt-5 text-amber-600 group-hover:text-red-600 transition-colors">
                <span className="text-sm font-semibold mr-2">View Issues</span>
      ...
      <div className="space-y-8">
        <div className="flex items-center gap-4 mb-8">
          <button
            ...
            className="group flex items-center gap-2 px-6 py-3 bg-white/90 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 text-gray-700 hover:text-amber-600 hover:border-amber-600 transition-all duration-300 hover:scale-105"
          >
            <ArrowLeft className="w-5 h-5 group-hover:-translate-x-1 transition-transform" />
            <span className="font-semibold">Back to Volumes</span>
          </button>
        </div>

        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-3 mb-4">
            <Scale className="w-12 h-12 text-amber-600 animate-pulse" />
            <h1 className="text-5xl font-bold bg-gradient-to-r from-slate-700 via-blue-700 to-indigo-700 bg-clip-text text-transparent">
              Volume {selectedVolume.number}
            </h1>
          </div>
          <p className="text-2xl text-gray-600 font-semibold mb-2">{selectedVolume.year}</p>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Select an issue to explore individual research papers and scholarly contributions
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {selectedVolume.issues.map((issue, index) => (
            <div
              key={issue.id}
              onClick={() => issue.pdf && handleIssueClick(issue)}
              className={`group relative p-6 rounded-2xl border-2 shadow-xl transition-all duration-300 transform hover:-translate-y-2 ${issue.pdf
                  ? 'bg-white/90 backdrop-blur-sm border-white/20 hover:shadow-2xl hover:border-amber-600 cursor-pointer'
                  : 'bg-gray-100/90 border-gray-300 cursor-not-allowed opacity-60'
                }`}
            ...
            >
              ...
              <div className="relative z-10">
                <div className={`flex items-center justify-center w-16 h-16 rounded-2xl mb-4 mx-auto transition-all duration-300 ${issue.pdf
                    ? 'bg-gradient-to-br from-amber-500 to-red-600 text-white group-hover:scale-110 shadow-lg'
                ...
                <div className="flex items-center justify-center gap-2 text-gray-600 mb-4">
                  ...
                  <p className="text-sm font-medium">{issue.period} {issue.year}</p>
                </div>

                {issue.pdf ? (
                  <div className="flex items-center justify-center text-amber-600 group-hover:text-red-600 transition-colors">
                    <span className="text-sm font-semibold mr-2">View Papers</span>
                    <ChevronRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                  </div>
                ) : (
                  <div className="text-center">
                    <span className="inline-flex items-center gap-2 px-3 py-1 bg-gray-200 rounded-full text-xs text-gray-500">
                      Coming Soon
                    </span>
                  </div>
                )}
  ...
  const renderPapers = () => {
    ...
    return (
      <div className="space-y-8">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-3 mb-4">
            <BookOpen className="w-12 h-12 text-amber-600 animate-pulse" />
            <h1 className="text-4xl sm:text-5xl font-bold bg-gradient-to-r from-slate-700 via-blue-700 to-indigo-700 bg-clip-text text-transparent">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Download complete issue or individual research papers
          </p>
        </div>

        <div className="max-w-5xl mx-auto">
          {selectedIssue.pdf && (
            <div className="mb-10 p-8 bg-gradient-to-br from-slate-800 via-blue-800 to-indigo-800 text-white rounded-3xl shadow-2xl transform hover:scale-[1.02] transition-transform duration-300">
              <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold mb-2">Complete Issue PDF</h3>
                    <p className="text-gray-200">All papers in a single comprehensive document</p>
                  </div>
                </div>
                <a
                  href={selectedIssue.pdf}
                  download
                  className="group px-8 py-4 bg-white text-slate-800 rounded-xl font-bold hover:bg-amber-400 hover:text-slate-900 transition-all duration-300 flex items-center gap-3 shadow-lg hover:shadow-xl hover:scale-105"
                >
          ...
          {papers.length > 0 && (
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-3xl font-bold text-gray-800">Individual Papers</h3>
              </div>
              <p className="text-gray-600 mb-8">
                Browse and download {papers.length} research papers from this issue
              </p>
            </div>
          )}
          ...
          <div className="grid grid-cols-1 gap-5">
            {papers.map((paper, index) => (
              <a
                ...
                href={paper.pdf}
                download
                className="group relative flex items-center gap-6 p-6 bg-white/90 backdrop-blur-sm border-2 border-white/20 rounded-2xl shadow-lg hover:shadow-2xl hover:border-amber-600 transition-all duration-300 transform hover:-translate-y-1"
                style={{ animationDelay: `${index * 50}ms` }}
              >
                <div className="absolute inset-0 bg-gradient-to-r from-amber-500/5 to-red-600/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>

                <div className="relative z-10 flex-shrink-0 w-14 h-14 bg-gradient-to-br from-slate-600 to-blue-600 text-white rounded-xl flex items-center justify-center group-hover:scale-110 group-hover:from-amber-500 group-hover:to-red-600 transition-all duration-300 shadow-md">
                ...
                <div className="relative z-10 flex items-center text-amber-600 group-hover:text-red-600 transition-colors">
                  <span className="text-sm font-bold mr-2 hidden sm:inline">Download PDF</span>
          ...
          {papers.length === 0 && (
            <div className="text-center py-16 bg-gradient-to-br from-gray-50 to-blue-50 rounded-3xl border-2 border-gray-200">
              ...
              <h3 className="text-2xl font-bold text-gray-700 mb-3">Individual Papers Coming Soon</h3>
              <p className="text-gray-600 max-w-md mx-auto">
                Individual papers for this issue will be available soon. Please download the complete issue above.
              </p>
            </div>
          )}
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className={`transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <div className="flex justify-center items-center space-x-4 mb-8">
              <Book className="w-16 h-16 text-amber-400 animate-bounce" />
            ...
            <p className="text-xl text-gray-200 max-w-4xl mx-auto leading-relaxed">
              A decade of groundbreaking research in law and social sciences, featuring scholarly contributions from around the world.
            </p>
          </div>
        </div>
      </section>
      ...
      <main className="relative -mt-10 z-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/20 p-8 sm:p-12">
